...
public class LopHoc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbt_giaovu = new javax.swing.JButton();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jtf_malop, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(71, 71, 71)
                        .addComponent(jtb_sua, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(64, 64, 64)))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jtf_tenlop, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(33, 33, 33)
                        .addComponent(jLabel4)
                        .addGap(18, 18, 18)
                        .addComponent(jcb_khoi, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(jtf_malop, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3)
                    ...
                    .addComponent(jLabel4)
                    .addComponent(jcb_khoi, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtb_xoa, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jtb_sua, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jbt_giaovu.setBackground(new java.awt.Color(255, 0, 0));
        jbt_giaovu.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jbt_giaovu.setText("Giáo Vụ");
        jbt_giaovu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbt_giaovuActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jbt_giaovu, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jtb_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtb_suaActionPerformed
      ...
      String malop = jtf_malop.getText().trim();
        ...
        boolean result = LopDAO.capNhatLop(lop);
        if (result) {
            LoadData();
            Moi();
        } else {
    ...
    private void jtb_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtb_xoaActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, "Bạn cần chọn tên Lớp cần xóa", "Thông báo", JOptionPane.WARNING_MESSAGE);
        }
        else
        {
            String maLop = jtf_malop.getText().trim();
    ...
    private void jtb_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtb_themActionPerformed
        ...
        if (khoi.equals("11"))
            ...
            k = 3;
        Lop lop = new Lop(tenlop, malop,k);
        boolean result = LopDAO.themLop(lop);
        if (result) {
            LoadData();
            Moi();
        } else {
    ...
    private void jbt_giaovuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbt_giaovuActionPerformed
        // TODO add your handling code here:
        KhoiLop lh = new KhoiLop();
        lh.setLocationRelativeTo(null);
        lh.setVisible(true);
    }//GEN-LAST:event_jbt_giaovuActionPerformed
    ...
    private javax.swing.JButton jbt_giaovu;
